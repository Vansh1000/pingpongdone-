...
function modelLoaded(){
  console.log("posenet is initialized ok;-;")
}
...
function startGame(){
  game_status = "start";
  document.getElementById("status").innerHTML = "Game is loading so just wait because it is loading........................."
}
...
fill("red");
 ...
 if(game_status = "start"){
   document.getElementById("status").innerHTML = "gama has loadeddaadada"
